...
**Cropper Studio**：因为平时经常需要处理一些视频和动图，苦于没有流畅顺滑的在线网站和轻量应用，所以自己动手开发了这款图形化软件界面。
...
- Node.js 18.0 或更高版本
- Git
- 确保 `bin/` 目录下已放置对应系统的 `ffmpeg` 二进制文件

### 安装与运行

```bash
# 1. 克隆项目仓库
git clone https://github.com/white66-7/video-handle.git
cd video-handle
